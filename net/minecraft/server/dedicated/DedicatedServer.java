...
public class DedicatedServer extends MinecraftServer implements IServer
{
    ...
    public DedicatedServer(File p_i47086_1_, DataFixer dataFixerIn, YggdrasilAuthenticationService authServiceIn, MinecraftSessionService sessionServiceIn, GameProfileRepository profileRepoIn, PlayerProfileCache profileCacheIn)
    {
        super(p_i47086_1_, Proxy.NO_PROXY, dataFixerIn, authServiceIn, sessionServiceIn, profileRepoIn, profileCacheIn);
    ...
    protected boolean startServer() throws IOException
    {
        ...
        else
        {
            ...
            this.setResourcePack(this.settings.getStringProperty("resource-pack", ""), this.func_184113_aK());
    ...
    {
        this.field_184115_n.resetLog();
        this.commandManager.executeCommand(this.field_184115_n, command);
        return this.field_184115_n.getLogContents();
    }
}
